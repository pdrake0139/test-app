...
<section class='container'>
          <hgroup>
            <h1>Welcome to Paige's Ruby application on OpenShift Example BOOP</h1>
          </hgroup>
...
$ git push</pre>
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
                ...
                <img src="http://www.safehavenrr.org/Images/bunny.jpg" alt="cute bunny">
